package com.wenjelly.generatorbackend.model.vo;

/*
 * @time 2024/3/28 13:51
 * @package com.wenjelly.generatorbackend.model.vo
...
public class GeneratorVO implements Serializable {
     ...
     * 文件配置（json字符串）
     */
    private Meta.FileConfigBean fileConfig;
    /**
     * 模型配置（json字符串）
     */
    private Meta.ModelConfigBean modelConfig;
    /**
     * 代码生成器产物路径
     */
    ...
    public static Generator voToObj(GeneratorVO generatorVO) {
        ...
        Meta.ModelConfigBean modelConfig = generatorVO.getModelConfig();
        generator.setModelConfig(JSONUtil.toJsonStr(modelConfig));
        Meta.FileConfigBean fileConfig = generatorVO.getFileConfig();
    ...
    public static GeneratorVO objToVo(Generator generator) {
        ...
        generatorVO.setFileConfig(JSONUtil.toBean(generator.getFileConfig(), Meta.FileConfigBean.class));
        generatorVO.setModelConfig(JSONUtil.toBean(generator.getModelConfig(), Meta.ModelConfigBean.class));
        return generatorVO;
    }
}
